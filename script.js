...
const soundFiles = {
        ...
        'rain': ['rain1.wav', 'rain2.wav'],
        'thunder': ['thunder1.wav', 'thunder2.wav', 'thunder3.wav'],
        'ocean': ['ocean1.wav', 'ocean2.wav'],
        'forest': ['forest1.wav', 'forest2.wav', 'forest3.wav'],
        'bird': ['bird.mp3' ], // Added bird sounds
        'waterfall': ['waterfall.mp3'], // Added waterfall sounds
        'campfire': ['campfire.mp3' ], // Added campfire sounds
        'underwater': ['underwater.mp3' ], // Added underwater sounds
        'wind': ['wind.mp3'] // Added wind sounds
...
const backgroundSettings = {
    ...
    custom: {
        backgroundColor: "#f0f8ff", // Customize your background color
        textColor: "#000080" // Customize text color
    }
};

function setBackgroundMode(mode) {
    const body = document.body;
    const settings = backgroundSettings[mode];
...
window.onload = function () {
    const darkModePreference = localStorage.getItem('darkMode');
    const backgroundMode = localStorage.getItem('backgroundMode') || 'light';
    if (darkModePreference === 'enabled') {
        document.body.classList.add('dark-mode');
        document.getElementById('dark-mode-icon').src = 'icons/darkmode.png';
    } else {
        document.body.classList.remove('dark-mode');
        document.getElementById('dark-mode-icon').src = 'icons/lightmode.png';
    }
...
function changeBackgroundMode(mode) {
    setBackgroundMode(mode); // Switch to custom background mode
